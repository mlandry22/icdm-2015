...
if __name__ == "__main__":
	# input file names #
	data_path = "./NewData/"
	dev_file = data_path + "dev_final_vars_seed4567.csv"
	...
	dev_pred_df.to_csv("dev_predictions_seed4567_d5.csv", index=False)
	val_pred_df.to_csv("val_predictions_seed4567_d5.csv", index=False)
	...
	test_writer = csv.writer(open("test_predictions_seed4567_d5.csv", "w"))
