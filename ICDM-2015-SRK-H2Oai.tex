...
\begin{abstract}
This report discusses methods to solve the ICDM 2015 competition to associate devices and cookies. 
...
The second stage utilized gradient boosted machines with 90 calculated features which became the focal point of solving the problem.
